    ...
    episode = {
        ...
        "steps": [
            {"step": 0, "action": "look around", "score_after_action": 10.0},
            {
                ...
                "retrieval_filtered_by_intent_count": 1,
                "retrieval_current_intent": "navigation",
                "retrieval_candidate_intents": ["navigation", "object_transfer"],

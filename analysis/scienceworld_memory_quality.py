...
def _memory_entry_to_annotation(
    *,
    ...
    return {
        ...
        "detector_source": entry.get("detector_source", ""),
        "failure_action": entry.get("failure_action", ""),
        "failure_observation": entry.get("failure_observation", ""),
        "score_before_action": entry.get("score_before_action"),
        "score_after_action": entry.get("score_after_action"),
        "score_delta": entry.get("score_delta"),
        "source_episode_success": entry.get(
            "source_episode_success",
            episode.get("success"),
        ),
        "source_episode_score": entry.get(
